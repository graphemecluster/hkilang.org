...
export default function PronunciationGuide({ language }: PronunciationGuideProps) {
  ...
  const data = pronunciationData[language as keyof typeof pronunciationData] || pronunciationData.waitau
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <Play
                        className={`h-4 w-4 ${
                          playingSound === `tone-${tone.number}` ? "text-red-800" : "text-gray-600"
                        }`}
                      />
