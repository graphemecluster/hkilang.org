...
export default function CulturalContext({ language }: CulturalContextProps) {
	...
	const culturalData = {
		waitau: {
			introduction: "圍頭話不僅是一種語言，更是承載著豐富文化內涵的非物質文化遺產。了解圍頭話的文化背景，有助於更深入地理解這門語言。",
			sections: [
				{
					title: "圍頭文化的歷史淵源",
					content: "圍頭文化可追溯至宋元時期，當時大量中原漢族南遷至珠江三角洲地區。明清時期，為抵禦海盜侵擾，新界西北部的居民修建了帶有防禦性質的圍牆村落，這些村落被稱為「圍村」，居民則被稱為「圍頭人」。圍頭人在長期的生產生活中，形成了獨特的語言、習俗和文化傳統，圍頭話正是這一文化的重要組成部分。",
					image: "/placeholder.svg?height=300&width=500",
				},
				{
					title: "圍頭話與宗族文化",
					content: "圍頭村落多以宗族為單位，同一宗族的成員居住在同一個圍村內。這���宗族聚居的生活方式，使得圍頭話在不同的村落間形成了細微的差異，形成了不同的「土語」。同時，宗族文化也深刻影響了圍頭話的詞彙系統，特別是在稱謂、禮儀和祭祀等方面的詞彙尤為豐富。",
					image: "/placeholder.svg?height=300&width=500",
				},
				{
					title: "圍頭話與傳統節慶",
					content: "圍頭地區保留了許多傳統節慶活動，如太平清醮、盂蘭勝會、春秋二祭等。在這些節慶活動中，圍頭話扮演著重要的角色，特別是在祭祀儀式、戲曲表演和民間歌謠中。這些活動不僅豐富了圍頭話的詞彙，也為圍頭話的傳承提供了重要場域。",
					image: "/placeholder.svg?height=300&width=500",
				},
				{
					title: "圍頭話與民間文學",
					content: "圍頭地區有豐富的民間文學傳統，包括民間故事、諺語、謎語和歌謠等。這些民間文學作品多以圍頭話口頭傳承，反映了圍頭人的生活智慧和價值觀念。例如，圍頭話中有大量與農業、天氣和人際關係相關的諺語，這些諺語簡潔明了，富有哲理，是圍頭文化的精華所在。",
					image: "/placeholder.svg?height=300&width=500",
				},
				{
					title: "圍頭話與傳統手工藝",
					content: "圍頭地區有多種傳統手工藝，如紮作、剪紙、編織和陶瓷等。這些手工藝活動形成了一套專業詞彙，豐富了圍頭話的詞彙系統。同時，手工藝人在製作過程中的交流和技藝傳承，也為圍頭話的傳承提供了重要途徑。",
					image: "/placeholder.svg?height=300&width=500",
				},
			],
			proverbs: [
