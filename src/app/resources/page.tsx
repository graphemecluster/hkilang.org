...
const languages = [
	{
		...
		description: "圍頭話是香港新界西北部原居民的方言，屬於粵語的一個分支。圍頭話保留了許多古老的語音和詞彙特點，是研究粵語歷史發展的重要資源。",
	...
	},
	{
		...
		name: "客家話",
		englishName: "Hakka",
		description: "客家話是客家人使用的漢語方言，在香港新界地區有著悠久的歷史。香港的客家話主要分佈在新界東北部和中部地區，保留了許多古老的語言特點。",
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		description: "汀角話是香港東北部汀角村的方言，具有獨特的語音和詞彙特點。汀角話融合了客家話和粵語的特點，是研究香港語言多樣性的重要資源。",
		image: "/placeholder.svg?height=400&width=600",
	...
	},
	{
		...
		description: "東平洲話是香港東平洲島上居民使用的方言，現已瀕臨消失。東平洲話受到閩南語和粵語的影響，形成了獨特的語言特點，是香港語言多樣性的重要組成部分。",
		image: "/placeholder.svg?height=400&width=600",
