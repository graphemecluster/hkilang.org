...
export interface LanguageIntroPageCulturalContext
  ...
  attributes: {
    sections: Schema.Attribute.Component<'shared.heading', true> &
      Schema.Attribute.Required;
    summary: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}

export interface LanguageIntroPageLanguageIntroSection
  extends Struct.ComponentSchema {
...
export interface LanguageIntroPageLanguageMap extends Struct.ComponentSchema {
  ...
  attributes: {
    heading: Schema.Attribute.Component<'shared.heading', false> &
      Schema.Attribute.Required;
    villages: Schema.Attribute.Component<'language-intro-page.village', true> &
      Schema.Attribute.Required;
  };
}

export interface LanguageIntroPageRelatedResources
  extends Struct.ComponentSchema {
