...
export interface AdminApiToken extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		localizations:
			& Schema.Attribute.Relation<"oneToMany", "admin::api-token">
			& Schema.Attribute.Private;
		name:
			& Schema.Attribute.String
			& Schema.Attribute.Required
		...
		type:
			& Schema.Attribute.Enumeration<["read-only", "full-access", "custom"]>
			& Schema.Attribute.Required
...
export interface AdminPermission extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations:
			& Schema.Attribute.Relation<"oneToMany", "admin::permission">
			& Schema.Attribute.Private;
...
export interface AdminRole extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations:
			& Schema.Attribute.Relation<"oneToMany", "admin::role">
			& Schema.Attribute.Private;
		name:
			& Schema.Attribute.String
			& Schema.Attribute.Required
...
export interface AdminUser extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations:
			& Schema.Attribute.Relation<"oneToMany", "admin::user">
			& Schema.Attribute.Private;
		password:
		...
		roles:
			& Schema.Attribute.Relation<"manyToMany", "admin::role">
			& Schema.Attribute.Private;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy:
			& Schema.Attribute.Relation<"oneToOne", "admin::user">
...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
	...
	attributes: {
		...
		localizations:
			...
			& Schema.Attribute.Private;
		members:
			& Schema.Attribute.Component<"about-page.member", true>
			& Schema.Attribute.Required;
		publishedAt: Schema.Attribute.DateTime;
		sections:
			& Schema.Attribute.Component<"about-page.about-section", true>
			& Schema.Attribute.Required;
		timeline:
			& Schema.Attribute.Component<"about-page.timeline-item", true>
			& Schema.Attribute.Required;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy:
			& Schema.Attribute.Relation<"oneToOne", "admin::user">
...
export interface ApiFaqPageFaqPage extends Struct.SingleTypeSchema {
	...
	attributes: {
		...
		publishedAt: Schema.Attribute.DateTime;
		questions:
			& Schema.Attribute.Component<"faq-page.faq-section", true>
			& Schema.Attribute.Required;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy:
			& Schema.Attribute.Relation<"oneToOne", "admin::user">
...
export interface ApiLanguageIntroPageLanguageIntroPage extends Struct.CollectionTypeSchema {
	...
	info: {
		description: "";
		displayName: "Language Intro Page";
		pluralName: "language-intro-pages";
		singularName: "language-intro-page";
	};
	options: {
		draftAndPublish: true;
	};
...
export interface ApiLanguageLanguage extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		introPage: Schema.Attribute.Relation<
			"oneToOne",
			"api::language-intro-page.language-intro-page"
		>;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiListedCharacterListedCharacter extends Struct.CollectionTypeSchema {
	...
	info: {
		description: "";
		displayName: "Listed Character";
		pluralName: "listed-characters";
		singularName: "listed-character";
	};
	options: {
		draftAndPublish: false;
	};
	attributes: {
		...
		localizations:
			& Schema.Attribute.Relation<
				"oneToMany",
				"api::listed-character.listed-character"
			>
			& Schema.Attribute.Private;
...
export interface ApiSurveyedLexicalDomainSurveyedLexicalDomain extends Struct.CollectionTypeSchema {
	...
	info: {
		description: "";
		displayName: "Surveyed Lexical Domain";
		pluralName: "surveyed-lexical-domains";
		singularName: "surveyed-lexical-domain";
	};
	options: {
		draftAndPublish: false;
	};
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations:
			& Schema.Attribute.Relation<"oneToMany", "api::tag.tag">
			& Schema.Attribute.Private;
		name: Schema.Attribute.String & Schema.Attribute.Required;
		publishedAt: Schema.Attribute.DateTime;
		slug: Schema.Attribute.UID & Schema.Attribute.Required;
...
export interface ApiWordOfTheDayWordOfTheDay extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		localizations:
			& Schema.Attribute.Relation<
				"oneToMany",
				"api::word-of-the-day.word-of-the-day"
			>
			& Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
		updatedAt: Schema.Attribute.DateTime;
...
export interface PluginContentReleasesReleaseAction extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		>;
		type:
			& Schema.Attribute.Enumeration<["publish", "unpublish"]>
			& Schema.Attribute.Required;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy:
			& Schema.Attribute.Relation<"oneToOne", "admin::user">
...
export interface PluginUploadFile extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		folder:
			& Schema.Attribute.Relation<"manyToOne", "plugin::upload.folder">
			& Schema.Attribute.Private;
		folderPath:
			& Schema.Attribute.String
			& Schema.Attribute.Required
